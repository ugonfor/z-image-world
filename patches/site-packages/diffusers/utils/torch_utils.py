...
if is_torch_available():
    ...
    BACKEND_EMPTY_CACHE = {
        ...
        "xpu": getattr(getattr(torch, "xpu", None), "empty_cache", None),
        "cpu": None,
        "mps": torch.mps.empty_cache if hasattr(torch, "mps") and hasattr(torch.mps, "empty_cache") else None,
        "default": None,
    }
    BACKEND_DEVICE_COUNT = {
        "cuda": torch.cuda.device_count,
        "xpu": getattr(getattr(torch, "xpu", None), "device_count", lambda: 0),
        "cpu": lambda: 0,
        "mps": lambda: 0,
        "default": 0,
    }
    BACKEND_MANUAL_SEED = {
        ...
        "xpu": getattr(getattr(torch, "xpu", None), "manual_seed", lambda s: None),
